# Contributing to next-starter

Thanks for your interest in contributing to next-starter! We're excited to have you here.

Please take a moment to review this document before submitting your first pull request. We also strongly recommend checking open [Issues](https://github.com/LobeM/next-starter/issues) and [Pull Requests](https://github.com/LobeM/next-starter/pulls) to see if someone else is working on something similar.

If you need any help or want to discuss ideas, feel free to join our community on [X](https://x.com/LobeMusonda).

## About This Project

next-starter is a powerful Visual Theme Editor designed for Tailwind CSS & shadcn/ui components. Websites built with shadcn/ui often share a similar look; tweakcn helps you visually customize these components to make your projects stand out.

## Project Structure

This repository contains the Next.js application for next-starter. Here's a simplified overview of the project's directory structure:
...
- **Create an Issue:** If you find a bug, have an idea for a new feature, or want to suggest an improvement, please [create an issue on GitHub](https://github.com/LobeM/next-starter/issues). This helps us track and prioritize feedback.
...
1.  **Fork the Repository:** Start by creating your own copy of the [next-starter repository](https://github.com/LobeM/next-starter) on GitHub. Click the "Fork" button in the top-right corner.
...
4.  **Open a Pull Request (PR):**
    ...
    - Go to the original [next-starter repository](https://github.com/LobeM/next-starter) on GitHub.
    ...
    - Ensure the base repository is `LobeM/next-starter` and the base branch is `main` (or the appropriate target branch).
