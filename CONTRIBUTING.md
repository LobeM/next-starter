...
next-starter is a Next.js starter template built to speed up project setup with production-ready foundational blocks. It includes a modern stack so developers can focus on shipping features instead of wiring tooling from scratch.
...
```
├── .husky/                  # Git hooks (pre-commit and commit-msg)
├── .vscode/                 # Workspace editor settings
├── actions/                 # Server Actions 
├── app/                     # App Router entrypoint
│   ├── (auth)/              # Authentication pages and related components
│   ├── (website)/           # Marketing/site routes and components
│   ├── api/                 # API routes
│   ├── globals.css          # Global styles and design tokens
│   └── layout.tsx           # Root application layout
├── assets/                  # Static logo/icon assets used in UI
├── components/
│   ├── theme/               # Theme providers and theme toggle components
...
├── lib/                     # Auth, permissions, email, and shared helpers
...
- **Spread the Word:** If you like this project, please share it with your friends, colleagues, and on social media. Helping grow the community makes the tool better for everyone.
- **Use the starter template:** The best feedback comes from real-world usage! As you use the editor, if you encounter any issues or have ideas for improvement, please let us know by creating an issue or reaching out on [X](https://x.com/LobeMusonda).
